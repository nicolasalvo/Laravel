                                ...
                                {games.map((game) => (
                                    <tr key={game.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <Link href={`/admin/games/${game.id}/edit`} className="text-indigo-600 hover:text-indigo-900 mr-4">Edit</Link>
                                            <Link href={`/admin/games/${game.id}`} className="text-blue-600 hover:text-blue-900 text-sm">Preview</Link>
                                        </td>
                                    </tr>
                                ))}
                                {games.length === 0 && (
